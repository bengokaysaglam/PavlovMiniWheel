...
class GoToGoal(Node):
    def __init__(self):
        ...
        self.declare_parameter("slowdown_radius", 0.25)
        self.declare_parameter("rotate_in_place_angle", 0.3)
    ...
    def compute_cmd(self) -> Twist:
        ...
        if abs(heading_error) > self.rotate_in_place_angle:
            ...
            # Hedefe yaklaşırken yavaşlama sağlar. Bu, mesafe küçükse orantısal azaltma sağlar.
